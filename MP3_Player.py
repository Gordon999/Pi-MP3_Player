...
class Player(Frame):
    ...
    def initUI(self):
        ...
        self.Button_AZ_artists = tk.Button(self.master, text = "A-Z Artists OFF",bg = "light blue", fg = "blue",width = 7, height = 2,command = self.AZ_Tracks, wraplength=80, justify=LEFT)
