...
class MP3Player(Frame):
    ...
    def initUI(self):
        ...
        self.tunes_dir  = "/media/pi/"          # where .mp3s are stored under, to use /home/pi/Music/ set to "/home/pi/"
        ...
        self.Button_Start.grid(row = 0, column = 0, padx = 10,pady = 12)
        ...
        self.Button_Pause.grid(row = 0, column = 1, padx = 0,pady = 12)
        ...
        self.Button_Pstart.grid(row = 0, column = 3,pady = 12)
        ...
        self.Button_TAlbum.grid(row = 0, column = 4,pady = 12)
        ...
        self.img.grid(row = 5, column = 0, columnspan = 2, rowspan = 5)
        ...
        B12 = tk.Button(self.Frame10, text = "QUIT",bg = "light blue",  width = 7, height = 2,command=self.exit).grid(row = 9, column = 5)
        ...
        self.Button_Shuffle.grid(row = 7, column = 5)
        ...
        self.Button_Artist_m3u.grid(row = 8, column = 5)
        ...
        self.Disp_track_no.grid(row = 5, column = 3, sticky = W)
        self.Disp_Total_tunes = tk.Label(self.Frame10, height=1, width=5,bg='white',font = 40, borderwidth=2, relief="groove")
        self.Disp_Total_tunes.grid(row = 5, column = 4, sticky = W)
        self.Disp_played = tk.Label(self.Frame10, height=1, width=5,bg='white',font = 40, borderwidth=2, relief="groove")
        self.Disp_played.grid(row = 6, column = 3, sticky = W)
        self.Disp_track_len = tk.Label(self.Frame10, height=1, width=5,bg='white',font = 40, borderwidth=2, relief="groove")
        self.Disp_track_len.grid(row = 6, column = 4, sticky = W)
        self.Disp_Drive = tk.Label(self.Frame10, height=1, width=10,bg= 'white', anchor="w", borderwidth=2, relief="groove")
        self.Disp_Drive.grid(row = 5, column = 5, columnspan = 2, sticky = E)
        self.Disp_Name_m3u = tk.Text(self.Frame10,height = 1, width=12,bg= 'white', borderwidth=2, relief="groove")
        self.Disp_Name_m3u.grid(row = 8, column = 3)
        self.Disp_Total_Plist = tk.Label(self.Frame10, height=1, width=6,bg='white',font = 40, borderwidth=2, relief="groove")
        self.Disp_Total_Plist.grid(row = 6, column = 5, columnspan = 2, sticky = E)
