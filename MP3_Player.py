...
# Pi_MP3_Player v15.31

#set display format
cutdown = 4 # 0 = 800x480, 1 = 320x240, 2 = 640x480, 3 = 480x800, 4 = 480x320 (Waveshare 2.8")
...
class MP3Player(Frame):
    ...
    def initUI(self):
        ...
        if cutdown == 4:
            ...
            self.volup      = 18                 # external volume up gpio input
            self.mute       = 24                 # external mute gpio input
        ...
        self.model          = 1
        self.light_on       = 0
        self.HP4_backlight  = 0    # Hyperpixel4 backlight control, set to 1. EXPERIMENTAL !!
        self.light          = 60   # Hyperpixel4 backlight dimming timer, in seconds
        self.dim            = 4    # Hyperpixel4 backlight dim , 4 = dim, 3 = off
        self.bright         = 200  # Hyperpixel4 backlight bright , 255 full brightness
        ...
        if os.path.exists ('/sys/devices/platform/i2c@0'): 
            ...
            if self.HP4_backlight == 1:
                ...
                import pigpio
                self.gpio = pigpio.pi()
                self.gpio.set_PWM_frequency(19,6006)
                self.gpio.set_PWM_dutycycle(19,self.bright)
        else:
            self.gpio_enable = 1
            import RPi.GPIO as GPIO
        ...
        if self.cutdown == 0:
            ...
            self.Button_Pause.grid(row = 0, column = 1, padx = 0,pady = 10)
            ...
            self.Button_Pstart.grid(row = 0, column = 3,pady = 10)
            ...
            self.Button_TAlbum.grid(row = 0, column = 4,pady = 10)
            ...
            self.Button_Shuffle = tk.Button(self.Frame10, text = "Shuffle", bg = "light blue", fg = "blue",width = 7, height = 2,command = self.Shuffle_Tracks, wraplength=80, justify=CENTER)
            ...
            self.Button_DELETE_m3u.grid(row = 9, column = 4, padx = 8)
            self.Button_repeat = tk.Button(self.Frame10, text = "Repeat", bg = "light blue",fg = "blue",width = 7, height = 2,command = self.Repeat, wraplength=80, justify=CENTER)
            ...
            if self.BT == 1:
                ...
                self.Button_Pstart.config(fg = "light gray",bg = "light gray")
        ...
        if self.cutdown == 2:
            self.length = 60
            self.Button_Start = tk.Button(self.Frame10, text = "PLAY Playlist", bg = "green",fg = "white",width = 5, height = 2,font = 18, command = self.Play, wraplength=80, justify=CENTER)
            self.Button_Start.grid(row = 0, column = 0, padx = 0,pady = 10)
            self.Button_Pause = tk.Button(self.Frame10, text = "Pause",bg = "light blue", width = 4, height = 2,command=self.Pause, wraplength=80, justify=CENTER)
            self.Button_Pause.grid(row = 0, column = 1, padx = 0,pady = 10)
            self.Button_Stop =  tk.Button(self.Frame10, text = "STOP",fg = "white",width = 5, height = 2,font = 20,command = self.Stop_Play)
            self.Button_Stop.grid(row = 0, column = 2)
            self.Button_Pstart = tk.Button(self.Frame10, text = "Gapless OFF", fg = "white", width = 5, height = 2,command=self.Gapless, wraplength=80, justify=CENTER)
            self.Button_Pstart.grid(row = 0, column = 3,pady = 10)
            self.Button_TAlbum = tk.Button(self.Frame10, text = "Play Album", bg = "light blue",fg = "blue", width = 5, height = 2,command=self.Play_Album, wraplength=60, justify=CENTER)
            self.Button_TAlbum.grid(row = 0, column = 4,pady = 10)
            ...
            self.Button_Shuffle = tk.Button(self.Frame10, text = "Shuffle", bg = "light blue", fg = "blue",width = 5, height = 2,command = self.Shuffle_Tracks, wraplength=80, justify=CENTER)
            self.Button_Shuffle.grid(row = 7, column = 6)
            self.Button_AZ_artists = tk.Button(self.Frame10, text = "A-Z Sort OFF",bg = "light blue", fg = "blue",width = 5, height = 2,command = self.AZ_Tracks, wraplength=80, justify=CENTER)
            self.Button_AZ_artists.grid(row = 7, column = 7)
            ...
            self.Button_repeat = tk.Button(self.Frame10, text = "Repeat", bg = "light blue",fg = "blue",width = 5, height = 2,command = self.Repeat, wraplength=80, justify=CENTER)
        ...
        if self.cutdown == 1:
            self.length = 24
            self.Button_Start = tk.Button(self.Frame10, text = "PLAY Playlist", bg = "green",fg = "white",width = 5, height = 2, command = self.Play, wraplength=50, justify=CENTER)
            self.Button_Start.grid(row = 0, column = 0)
            self.Button_Stop =  tk.Button(self.Frame10, text = "STOP",fg = "white",width = 3, height = 2,command = self.Stop_Play)
            self.Button_Stop.grid(row = 0, column = 1)
            self.Button_TAlbum = tk.Button(self.Frame10, text = "PLAY Album", bg = "light blue",fg = "blue", width = 4, height = 2,command=self.Play_Album, wraplength=50, justify=CENTER)
            ...
            self.B11 = tk.Button(self.Frame10, text = "RELOAD",width = 5, height = 1, bg = "#c5c",command = self.RELOAD_List, wraplength=80, justify=CENTER)
            self.B11.grid(row = 6, column = 0)
            B12 = tk.Button(self.Frame10, text = "QUIT",bg = "light blue",  width = 4, height = 1,command=self.exit).grid(row = 6, column = 3)
            B14 = tk.Button(self.Frame10, text = "Shutdn",   bg = "gray",width = 4, height = 1,command = self.Shutdown).grid(row = 6, column = 4)
            self.Button_Shuffle = tk.Button(self.Frame10, text = "Shuffle", bg = "light blue", fg = "blue",width = 3, height = 1,command = self.Shuffle_Tracks, wraplength=80, justify=CENTER)
        ...
        if self.cutdown == 3:
            ...
            self.Button_Start.grid(row = 0, column = 0)
            self.Button_Stop =  tk.Button(self.Frame10, text = "STOP",fg = "white",width = 7, height = 2,command = self.Stop_Play)
            self.Button_Stop.grid(row = 0, column = 1)
            self.Button_TAlbum = tk.Button(self.Frame10, text = "PLAY Album", bg = "light blue",fg = "blue", width = 7, height = 2,command=self.Play_Album, wraplength=50, justify=CENTER)
            self.Button_TAlbum.grid(row = 0, column = 2,pady = 0)
            ...
            self.Button_Pause.grid(row = 6, column = 2)
            self.Button_Pstart = tk.Button(self.Frame10, text = "Gapless OFF", fg = "white", width = 7, height = 2,command=self.Gapless, wraplength=80, justify=CENTER)
            self.Button_Pstart.grid(row = 15, column = 2)
            ...
            self.Button_Shuffle = tk.Button(self.Frame10, text = "Shuffle", bg = "light blue", fg = "blue",width = 6, height = 2,command = self.Shuffle_Tracks, wraplength=80, justify=CENTER)
            ...
            self.Button_repeat = tk.Button(self.Frame10, text = "Repeat", bg = "light blue",fg = "blue",width = 6, height = 2,command = self.Repeat, wraplength=80, justify=CENTER)
            self.Button_repeat.grid(row = 6, column = 1)
            self.Disp_sleep = tk.Button(self.Frame10, text = "OFF", bg = "white",fg = "blue",width = 2, height = 2,command = self.sleep_off)
            self.Disp_sleep.grid(row = 15, column = 1, sticky = W)
            self.Button_Track_m3u = tk.Button(self.Frame10, text = "ADD track   to .m3u", bg = "light green",width = 7, height = 2,command = self.Track_m3u, wraplength=80, justify=CENTER)
        ...
        if self.cutdown == 4:
            self.length = 30
            self.Button_Start = tk.Button(self.Frame10, text = "PLAY Playlist", bg = "green",fg = "white",width = 8, height = 2, command = self.Play, wraplength=50, justify=CENTER)
            self.Button_Start.grid(row = 0, column = 0)
            self.Button_Stop =  tk.Button(self.Frame10, text = "STOP",fg = "white",width = 8, height = 2,command = self.Stop_Play)
            self.Button_Stop.grid(row = 0, column = 1)
            self.Button_TAlbum = tk.Button(self.Frame10, text = "PLAY Album", bg = "light blue",fg = "blue", width = 8, height = 2,command=self.Play_Album, wraplength=50, justify=CENTER)
            self.Button_TAlbum.grid(row = 0, column = 2,pady = 0)
            B1 =  tk.Button(self.Frame10, text = " < Vol " + "...", wraplength=40,    bg = "yellow",width = 7, height = 2,command = self.volume_DN)
            B1.grid(row = 0, column = 3)
            self.B2 =  tk.Button(self.Frame10, text = "Vol > " + str(self.volume), wraplength=55,bg = "yellow",width = 7, height = 2,command = self.volume_UP)
            ...
            self.B10.grid(row =4, column = 4)
            self.B13 = tk.Button(self.Frame10, text = "NextAZ",   width = 6, height = 1,bg = "light blue",command=self.nextAZ,repeatdelay=250, repeatinterval=500)
            self.B13.grid(row = 5, column = 4, pady = 0)
            self.B11 = tk.Button(self.Frame10, text = "RELOAD",width = 6, height = 2, bg = "#c5c",command = self.RELOAD_List, wraplength=80, justify=CENTER)
            self.B11.grid(row = 6, column = 0)
            B12 = tk.Button(self.Frame10, text = "QUIT",bg = "light blue",  width = 6, height = 2,command=self.exit).grid(row = 6, column = 3)
            B14 = tk.Button(self.Frame10, text = "Shutdn",   bg = "gray",width = 6, height = 2,command = self.Shutdown).grid(row = 6, column = 4)
            self.Button_Shuffle = tk.Button(self.Frame10, text = "Shuffle", bg = "light blue", fg = "blue",width = 6, height = 2,command = self.Shuffle_Tracks, wraplength=80, justify=CENTER)
            self.Button_Shuffle.grid(row = 6, column = 1)
            ...
            self.Disp_plist_name.grid(row = 1, column = 1, columnspan = 3)
            self.Disp_plist_name.config(text=" " + self.que_dir[len(self.m3u_dir):])
            self.Disp_artist_name = tk.Label(self.Frame10, height=1, width=30,bg='white', anchor="w", borderwidth=2, relief="groove")
            self.Disp_artist_name.grid(row = 2, column = 1,columnspan = 3)
            self.Disp_album_name = tk.Label(self.Frame10, height=1, width=30,bg='white', anchor="w", borderwidth=2, relief="groove")
            self.Disp_album_name.grid(row = 3, column = 1, columnspan = 3)
            self.Disp_track_name = tk.Label(self.Frame10, height=1, width=30,bg='white', anchor="w", borderwidth=2, relief="groove")
            self.Disp_track_name.grid(row = 4, column = 1, columnspan = 3)
            self.Disp_track_no = tk.Label(self.Frame10, height=1, width=5,bg='white', borderwidth=2, relief="groove")
            self.Disp_track_no.grid(row = 5, column = 0)
            self.Disp_Total_tunes = tk.Label(self.Frame10, height=1, width=5,bg='white', borderwidth=2, relief="groove")
    ...
    def Play(self):
        if self.HP4_backlight == 1 and self.gpio_enable == 0 and (self.album_start == 1 or self.stopstart == 1):
            self.gpio.set_PWM_dutycycle(19,self.bright)
            ...
            for mixername in alsaaudio.mixers():
                if str(mixername) == "PCM" or str(mixername) == "Master" or str(mixername) == "Capture" or str(mixername) == "Headphone" or str(mixername) == "HDMI":
                    ...
                    if self.cutdown == 0 or self.cutdown == 2 or cutdown == 3:
                        self.Button_Pstart.config(fg = "black",bg = "light blue")
        ...
        if len(self.tunes) > 0 and self.play == 0 and self.paused == 0:
            ...
            if os.path.exists(self.track):
                ...
                if self.play == 1:
                    ...
                    if self.trace == 1:
                        print ("Start_Play - Stop Play (No track found)")
                    self.Stop_Play()
    ...
    def Start_Play2(self):
        ...
        if self.cutdown == 0 or self.cutdown == 2 or self.cutdown == 3:
            ...
            if len(pictures) > 0:
                ...
                if os.path.exists(self.mp3_jpg):
                    self.img.config(image = self.render)
        self.track_name7 = self.track_name + "  "
    ...
    def playing(self):
        if time.time() - self.light_on > self.light and self.gpio_enable == 0 and self.HP4_backlight == 1 :
            self.gpio.set_PWM_dutycycle(19,self.dim)
        self.count7 += 1
        # scroll artist name
        ...
        if os.path.exists(self.track):
            if time.time() - self.start > (self.track_len - self.gapless) - (self.BT) and self.play == 1 and self.paused == 0:
                ...
                if self.model == 0:
                    ...
                    if float(c[14:19]) > 1.4 and float(d[0:4]) > 1.4 and float(e[0:4]) > 1.4:
                        self.Stop_Play()
                    else:
                        self.Start_Play()
                else:
    ...
    def Pause(self):
        if self.gpio_enable == 0 and self.HP4_backlight == 1 :
            self.gpio.set_PWM_dutycycle(19,self.bright)
            self.light_on = time.time()
        if self.BT == 0:
            ...
            if self.paused == 0 and self.stopstart == 1:
                ...
                if os.path.exists(self.mp3_jpg) and self.cutdown !=1  and self.cutdown != 4:
                    self.img.config(image = self.render)
                player.pause()
            # if self.paused set (paused) then unset it and unpause
                ...
                self.Button_Pause.config(fg = "black",bg = "light blue", text ="Pause")
                if os.path.exists(self.mp3c_jpg) and self.cutdown !=1 and self.cutdown != 4:
                    self.img.config(image = self.renderc)
                player.pause()
    ...
    def Play_Album(self):
        ...
        if self.trace == 1:
            print ("Play Album")
        if self.paused == 0 and len(self.tunes) > 0 and self.album_start == 0 and self.stopstart == 0:
            self.album_length  = 0
            self.plist_length  = 0
            self.album_trig    = 0
            self.plist_trig    = 0
            ...
            if self.cutdown == 0 or self.cutdown == 2 or self.cutdown == 3:
                ...
                self.Button_repeat.config(bg = "light blue",fg = "blue",text = "Repeat Album")
            self.Button_Shuffle.config(fg = "white",bg = "light grey", text = "Shuffle")
    ...
    def Check_Wheel(self):
        ...
        if self.album_start == 0 or self.stopstart == 1:
            ...
            if x2 >= 0 and y2 < 0:
                ...
                self.t = int(self.t * 4)
            # if cursor on the wheel position then show the wheel (instead of album cover)
            if math.sqrt((x2*x2)+ (y2*y2)) > 40 and math.sqrt((x2*x2)+ (y2*y2)) < 100 :
                ...
                self.old_t = self.t
        self.after(200, self.Check_Wheel)
    ...
    def Next_m3u(self):
        if self.paused == 0 and self.album_start == 0 and os.path.exists(self.que_dir):
            ...
            self.sorted = 0
            if self.cutdown == 0 or self.cutdown == 2 or self.cutdown == 3:
                self.Button_AZ_artists.config(bg = "light blue",fg = "blue",text = "A-Z Sort")
            self.Time_Left_Play()
    ...
    def Repeat(self):
        ...
        if self.paused == 0 and self.album_start == 0 and os.path.exists(self.que_dir):
            ...
            if self.repeat_count == 1:
                ...
                self.repeat = 0
                self.repeat_track = 0
                self.Button_repeat.config(bg = "light blue",fg = "blue",text = "Repeat")
            if self.play == 1:
                self.Start_Play()
            else:
                self.Show_Track()
    ...
    def DelPL_m3u(self):
        if os.path.exists(self.que_dir) and self.paused == 0 and self.album_start == 0:
            Name = str(self.Disp_Name_m3u.get('1.0','20.0')).strip()
            if (len(Name) > 0 or self.mute == 1) and Name != self.m3u_def:
                if Name == "FAV":
                    Name = "FAVourites"
                if self.mute == 1 and Name == "":
