...
class Player(Frame):
    ...
    def initUI(self): 
        ...
        self.Button_Start = tk.Button(self.master, text = "Start Play", bg = "green",fg = "white",width = 7, height = 2,font = 20, command = self.Start_Play)
        self.Button_Start.grid(row = 0, column = 0, pady = 12)
        self.Button_Stop =  tk.Button(self.master, text = "Stop  Play",fg = "white",width = 7, height = 2,command = self.Stop_Play)
        self.Button_Stop.grid(row = 0, column = 1,padx = 40)
        ...
        B11 = tk.Button(self.master, text = "New Track List",width = 9, height = 2, command = self.New_Track_List).grid(row = 6, column = 5,padx = 30, pady = 30)
        B12 = tk.Button(self.master, text = "Shuffle Tracks", fg = "blue",width = 9, height = 2,command = self.Shuffle_Tracks).grid(row = 7, column = 3,padx = 30, pady = 0)
        ...
        B14 = tk.Button(self.master, text = "QUIT",       bg = "light green",width = 7, height = 2,command=self.exit).grid(row = 8, column = 0,padx = 30, pady = 21)
        self.Button_Sleep = tk.Button(self.master, text = "SLEEP", bg = "light blue",width = 7, height = 2,command = self.sleep)
        self.Button_Sleep.grid(row = 8, column = 1, padx = 30)
