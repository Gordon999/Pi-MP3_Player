...
class MP3Player(Frame):
    ...
    def initUI(self):
        ...
        self.dsf_search     = self.m_user[0] + "/*/*/*/*.dsf"  # search criteria for flacs (/media/pi/USBDrive Name/Artist Name/Album Name/Tracks.dsf)
        self.m4a_search     = self.m_user[0] + "/*/*/*/*.m4a"  # search criteria for flacs (/media/pi/USBDrive Name/Artist Name/Album Name/Tracks.m4a)
        ...
        self.wav2_search     = "/media/*/*/*/*.wav"     # search criteria for flacs (/media/Drive/A/Artist Name - Album Name/Tracks.wav)
