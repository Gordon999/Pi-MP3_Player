...
class Player(Frame):
    ...
    def initUI(self):
        ...
        B11 = tk.Button(self.master, text = " RELOAD " + self.m3u_def ,width = 7, height = 2, bg = "#c5c",command = self.New_Track_List, wraplength=80, justify=CENTER).grid(row = 6, column = 1,padx = 0,)
        ...
        B14 = tk.Button(self.master, text = "Next A-Z", width = 7, height = 1,bg = "light blue",command=self.nextAZ).grid(row = 5, column = 4, pady = 5)
        ...
        self.Button_Track_m3u = tk.Button(self.master, text = "ADD album   to .m3u", bg = "light green",width = 7, height = 2,command = self.Album_m3u, wraplength=80, justify=CENTER)
        self.Button_Track_m3u.grid(row = 7, column = 3, padx = 0, pady = 10)
        self.Button_Track_m3u = tk.Button(self.master, text = "ADD P-list   to .m3u", bg = "light green",width = 7, height = 2,command = self.PList_m3u, wraplength=80, justify=CENTER)
    ...
    def New_Track_List(self):
        ...
        self.m3us = glob.glob(self.m3u_dir + "*.m3u")
        self.m3us.insert(0,self.m3u_dir + self.m3u_def + ".m3u")
        self.Disp_plist_name.config(text = self.m3u_dir + self.m3u_def + ".m3u")
        self.Disp_Track_m3u.delete('1.0','20.0')
        if self.play == 0:
            self.Show_Track()
