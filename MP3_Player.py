...
fullscreen = 1
global cutdown
cutdown = 2 # 0 = 840x480, 1 = 320x240, 2 = 640 x 480

# Pi_MP3_Player v15.11
...
class MP3Player(Frame):
    ...
    def initUI(self):
        ...
        if self.cutdown == 2:
            ...
            if self.m == 0:
                ...
                self.Button_volume = tk.Button(self.Frame10, text = self.volume, bg = "white",fg = "green",width = 1, height = 2,command = self.Mute)
            self.Button_volume.grid(row = 0, column = 6,pady = 0)
            B2 =  tk.Button(self.Frame10, text = "Vol >",      bg = "yellow",width = 5, height = 2,command = self.volume_UP)
            B2.grid(row = 0, column = 7)
        ...
        if self.cutdown == 1:
            self.Button_Start = tk.Button(self.Frame10, text = "PLAY Playlist", bg = "green",fg = "white",width = 3, height = 2, command = self.Play, wraplength=50, justify=CENTER)
            self.Button_Start.grid(row = 0, column = 0)
            self.Button_Stop =  tk.Button(self.Frame10, text = "STOP",fg = "white",width = 3, height = 2,font = 20,command = self.Stop_Play)
            ...
            B1 =  tk.Button(self.Frame10, text = " < Vol ",    bg = "yellow",width = 3, height = 2,command = self.volume_DN)
            B1.grid(row = 0, column = 3)
            B2 =  tk.Button(self.Frame10, text = "Vol >",      bg = "yellow",width = 3, height = 2,command = self.volume_UP)
            ...
            B14 = tk.Button(self.Frame10, text = "Shutdown",   bg = "gray",width = 4, height = 1,command = self.Shutdown).grid(row = 6, column = 4)
        ...
        if os.path.exists(self.mp3_jpg) and (self.cutdown == 0 or self.cutdown == 2):
    ...
    def Check_switches(self):
        ...
        if (self.album_start == 0 or self.stopstart == 1) and (self.cutdown == 0 or self.cutdown == 2):
            x = self.master.winfo_pointerx()
            y = self.master.winfo_pointery()
            abs_x = self.master.winfo_pointerx() - self.master.winfo_rootx()
            abs_y = self.master.winfo_pointery() - self.master.winfo_rooty()
