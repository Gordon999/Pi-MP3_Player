...
class MP3Player(Frame):
    ...
    def initUI(self):
        ...
        self.dsf_search     = self.m_user[0] + "/*/*/*/*.dsf"   # search criteria for DSFs  (/media/pi/USBDrive Name/Artist Name/Album Name/Tracks.dsf)
        ...
        #read USB drives
        self.USB_Drives = os.listdir(self.m_user[0] + "")
    ...
    def Roberts_mp2(self):
        ...
        Radio_Files = []
        New_Drive   = ""
        USB_Files   = os.listdir(self.m_user[0] + "")
        ...
        if New_Drive != "":
            for x in range(0,len(USB_Files)):
                Radio_Files += glob.glob(self.m_user[0] + "/" + New_Drive + "/*/*.mp2")
            for x in range(0,len(Radio_Files)):
                ...
                if ff.count(',') == 2:
                    gf,hf,jf = ff.split(",")
                    kf,lf = jf.split("-")
                    new_dir1 = self.m_user[0] + "/" + df + "/" + gf 
                    new_dir2 = self.m_user[0] + "/" + df + "/" + gf + "/" + hf + "_" + kf + "-" + lf[0:2]
                elif ff.count('_') == 1:
                    now = datetime.datetime.now()
                    tf = now.strftime("%y%m%d")
                    gf,lf = ff.split("_")
                    new_dir1 = self.m_user[0] + "/" + df + "/" + gf 
                    new_dir2 = self.m_user[0] + "/" + df + "/" + gf + "/" + tf + "-" + lf[0:-4]
        ...
        # search for Roberts or Yaakin mp3 files
            self.mp3 = glob.glob(self.m_user[0] + "/" + New_Drive + "/*/*/*.mp3")
            if len (self.mp3) > 0 :
