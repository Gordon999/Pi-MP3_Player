...
class MP3Player(Frame):
    ...
    def initUI(self):
        ...
        self.Button_Start = tk.Button(self.master, text = "PLAY Playlist", bg = "green",fg = "white",width = 7, height = 2,font = 20, command = self.Play, wraplength=80, justify=CENTER)
        self.Button_Start.grid(row = 0, column = 0, padx = 24,pady = 12)
        self.Button_Pause = tk.Button(self.master, text = "Pause",bg = "light blue", width = 7, height = 2,command=self.Pause, wraplength=80, justify=CENTER)
        ...
        self.Button_TAlbum = tk.Button(self.master, text = "Play Album", bg = "light blue",fg = "blue", width = 7, height = 2,command=self.Play_Album, wraplength=80, justify=CENTER)
        ...
        self.Button_Shuffle = tk.Button(self.master, text = "Shuffle P-LIST OFF", bg = "light blue", fg = "blue",width = 7, height = 2,command = self.Shuffle_Tracks, wraplength=80, justify=CENTER)
        self.Button_Shuffle.grid(row = 6, column = 3, padx = 15)
        self.Button_AZ_artists = tk.Button(self.master, text = "A-Z Sort OFF",bg = "light blue", fg = "blue",width = 7, height = 2,command = self.AZ_Tracks, wraplength=80, justify=CENTER)
        ...
        self.Button_repeat = tk.Button(self.master, text = "Repeat OFF", bg = "light blue",fg = "blue",width = 7, height = 2,command = self.Repeat, wraplength=80, justify=CENTER)
        self.Button_repeat.grid(row = 6, column = 2, padx = 10)
        self.Disp_sleep = tk.Button(self.master, text = "OFF", bg = "white",fg = "blue",width = 2, height = 2,command = self.sleep_off)
        self.Disp_sleep.place(x = 345, y = 425)
        ...
        self.B3 =  tk.Button(self.master, text = "< P-list",   bg = "light blue",width = 7, height = 1,command = self.Prev_m3u,repeatdelay=1000, repeatinterval=500)
        self.B3.grid(row = 1, column = 0,padx = 0)
        self.B4 =  tk.Button(self.master, text = "P-list >",   bg = "light blue",width = 7, height = 1,command = self.Next_m3u,repeatdelay=1000, repeatinterval=500)
        self.B4.grid(row = 1, column = 4,padx = 10)
        self.B5 =  tk.Button(self.master, text = "< Artist",   bg = "light blue",fg = "red",width = 7, height = 2,command = self.Prev_Artist,repeatdelay=1000, repeatinterval=500)
        self.B5.grid(row = 2, column = 0,padx = 0)
        self.B6 =  tk.Button(self.master, text = "Artist >",   bg = "light blue",width = 7, height = 2,command = self.Next_Artist,repeatdelay=1000, repeatinterval=500)
        self.B6.grid(row = 2, column = 4,padx = 10)
        self.B7 =  tk.Button(self.master, text = "< Album",    bg = "light blue",width = 7, height = 2,command = self.Prev_Album,repeatdelay=1000, repeatinterval=500)
        self.B7.grid(row = 3, column = 0,padx = 0)
        self.B8 =  tk.Button(self.master, text = "Album >",     bg = "light blue",width = 7, height = 2,command = self.Next_Album,repeatdelay=1000, repeatinterval=500)
        self.B8.grid(row = 3, column = 4,padx = 10)
        self.B9 =  tk.Button(self.master, text = "< Track",    bg = "light blue",width = 7, height = 2,command = self.Prev_Track,repeatdelay=1000, repeatinterval=500)
        self.B9.grid(row = 4, column = 0,padx = 0)
        self.B10 = tk.Button(self.master, text = "Track >",    bg = "light blue",width = 7, height = 2,command = self.Next_Track,repeatdelay=1000, repeatinterval=500)
        self.B10.grid(row = 4, column = 4,padx = 10)
        self.B11 = tk.Button(self.master, text = " RELOAD " + self.m3u_def ,width = 7, height = 2, bg = "#c5c",command = self.RELOAD_List, wraplength=80, justify=CENTER)
        self.B11.grid(row = 6, column = 1,padx = 0)
        B12 = tk.Button(self.master, text = "QUIT",bg = "light blue",  width = 7, height = 2,command=self.exit).grid(row = 8, column = 3)
        self.B13 = tk.Button(self.master, text = "Next A-Z",   width = 7, height = 1,bg = "light blue",command=self.nextAZ,repeatdelay=250, repeatinterval=500)
        self.B13.grid(row = 5, column = 4, pady = 13)
        B14 = tk.Button(self.master, text = "Shutdown",   bg = "gray",width = 7, height = 2,command = self.Shutdown).grid(row = 8, column = 4)
        self.B15 = tk.Button(self.master, text = "Add track to FAV .m3u  " ,width = 7, height = 2, bg = "light green",command = self.FAV_List, wraplength=80, justify=CENTER)
        self.B15.place(x = 347, y = 308)
        ...
        if not os.path.exists(self.que_dir):
            ...
            #self.tunes[0:13] = random.sample(self.tunes[0:13], 13)
