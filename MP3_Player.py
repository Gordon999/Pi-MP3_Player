...
class MP3Player(Frame):
    ...
    def initUI(self):
        ...
        self.Button_Pstart = tk.Button(self.master, text = "Gapless OFF", fg = "white", width = 7, height = 2,command=self.Pstart, wraplength=80, justify=CENTER)
