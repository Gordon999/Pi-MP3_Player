...
class MP3Player(Frame):
    ...
    def initUI(self):
        ...
        self.HP4_backlight  = 0                         # Hyperpixeself.L4 backlight control, set to 1.    Uses GPIO 19. EXPERIMENTAL , may flicker!!
        ...
        # check Lasttrack3.txt exists, if not then write default values.
        # Used for recalling last Radio Station ,volume etc, and restarting if using a Pi Zero.
        track  = 0
        radio  = 0
        volume = 80
        ...
        # check for HyperPixel4 LCD and if so disable GPIO controls, as it uses all of them.
