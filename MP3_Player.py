...
class MP3Player(Frame):
    ...
    def initUI(self):
        ...
        if self.cutdown == 1:
            ...
            self.Button_Stop =  tk.Button(self.Frame10, text = "STOP",fg = "white",width = 4, height = 2,command = self.Stop_Play)
            self.Button_Stop.grid(row = 0, column = 1)
            self.Button_TAlbum = tk.Button(self.Frame10, text = "PLAY Album", bg = "light blue",fg = "blue", width = 5, height = 2,command=self.Play_Album, wraplength=50, justify=CENTER)
            ...
            self.Button_Shuffle = tk.Button(self.Frame10, text = "Shuffle", bg = "light blue", fg = "blue",width = 4, height = 1,command = self.Shuffle_Tracks, wraplength=80, justify=CENTER)
            self.Button_Shuffle.grid(row = 6, column = 1)
            self.Button_Pause = tk.Button(self.Frame10, text = "Pause",bg = "light blue", width = 5, height = 1,command=self.Pause, wraplength=80, justify=CENTER)
    ...
    def Pause(self):
        if self.BT == 0:
            ...
            # if self.paused set (paused) then unset it and unpause
                ...
                self.Button_Pause.config(fg = "black",bg = "light blue", text ="Pause")
                if os.path.exists(self.mp3c_jpg) and self.cutdown !=1:
                    self.img.config(image = self.renderc)
                player.pause()
