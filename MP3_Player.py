...
class MP3Player(Frame):
    ...
    def initUI(self):
        ...
        L5.grid(row = 5, column = 4, sticky = E,padx = 6)
        L6 = tk.Label(self.Frame10, text="Playlist :")
        L6.grid(row = 6, column = 4, sticky = E,padx = 6)
        ...
        self.Disp_Drive = tk.Label(self.Frame10, height=1, width=12,bg= 'white', anchor="w", borderwidth=2, relief="groove")
        self.Disp_Drive.grid(row = 5, column = 5, columnspan = 2, sticky = W)
