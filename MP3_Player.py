...
class MP3Player(Frame):
    ...
    def initUI(self):
        ...
        self.Radio_Stns = ["BBC World Service","http://bbcwssc.ic.llnwd.net/stream/bbcwssc_mp1_ws-eieuk_backup",
    ...
    def Prev_m3u(self):
        if self.Radio_ON == 1:
            ...
            os.killpg(self.p.pid, signal.SIGTERM)
            rpistr = "mplayer -nocache " + self.Radio_Stns[self.Radio + 1]
            self.p = subprocess.Popen(rpistr, shell=True, preexec_fn=os.setsid)
