...
class MP3Player(Frame):
    ...
    def initUI(self):
        ...
        self.mp3_jpg    = "mp3.jpg"             # logo including the 'wheel' 
    ...
    def Wheel_Opt_Button(self,u):
        ...
        if math.sqrt((x2*x2)+ (y2*y2)) < 30 and self.stopstart == 0:
            ...
            if self.wheel_opt > 3:
                self.wheel_opt = 0
            self.B3.config(fg = "black",bg = "light blue")
            self.B5.config(fg = "black",bg = "light blue")
            self.B7.config(fg = "black",bg = "light blue")
            self.B9.config(fg = "black",bg = "light blue")
            if self.wheel_opt == 0:
    ...
    def Play_Album(self):
        if self.paused == 0 and len(self.tunes) > 0:
            ...
            if self.album_start > 0 and self.shutdown == 0:
                ...
                self.Button_TAlbum.config(fg = "blue",bg = "light grey", text = "Play Album & SLEEP")
            else:
                stop = 0
                if self.track_no == 0:
                    stop = 1
                while stop == 0:
                    ...
                    if self.track_no == 0:
                        stop = 1
                self.Button_TAlbum.config(fg = "blue", text = "Play Album & SLEEP")
                self.album_track = 0
                if self.album_start == 0:
                    self.album_start = 1
                    self.stopstart = 1
    ...
    def sleep_off(self):
        if self.shutdown == 1 or self.sleep_time > 0:
            ...
            if self.album_start == 1:
                ...
                self.Button_TAlbum.config(fg = "blue",bg = "light grey", text = "Play Album")
