...
class Player(Frame):
    ...
    def initUI(self):
        ...
        GPIO.setup(36,GPIO.IN, pull_up_down=GPIO.PUD_UP) # volume down whilst playing
        GPIO.setup(38,GPIO.IN, pull_up_down=GPIO.PUD_UP) # stop play
        GPIO.setup(40,GPIO.IN, pull_up_down=GPIO.PUD_UP) # volume up whilst playing
        ...
        self.Button_Album_m3u.grid(row = 7, column = 3, padx = 0, pady = 10)
    ...
    def playing(self):
        ...
        if self.play == 1 and self.inseq == 1:
            tplayed = (self.total - (time.time() - self.start2)) 
            ...
            if self.minutes < 0 or self.seconds < 0:
                ...
                self.Disp_Total_Plist.config(text = " > 120 " )
        elif self.inseq == 0:
