...
class MP3Player(Frame):
    ...
    def sleep(self):
        ...
        if self.sleep_time == 0:
            self.Button_Sleep.config(fg = "black",bg = "light blue", text = "SLEEP")
    ...
    def exit(self):
        ...
        self.master.destroy()
        self.LCD_pwm.close()
        os.system("raspi-gpio set " + self.LCD_LED_pin + " op")
        os.system("raspi-gpio set " + self.LCD_LED_pin + " dh")
        sys.exit()
