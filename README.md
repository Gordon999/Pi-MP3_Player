...
- gpio_enable added to allow the external gpio switches to be disabled if using a HyperPixel4 display, as it upsets the colours. You can leave them enables but colours will be affected.
